...
```{r, CE-BFH_Zitatationsnetzwerk_Senat-1_schwarzweiss, fig.width = 28, fig.height = 16, dpi = 150, dev = "png", fig.cap = "Das interne Zitationsnetzwerk (Aktenzeichen) des 1. Senats des Bundesfinanzhofs (Sugiyama Layout)."}
...
```{r, CE-BFH_Zitatationsnetzwerk_Senat-6_schwarzweiss, fig.width = 28, fig.height = 16, dpi = 150, dev = "png", fig.cap = "Das interne Zitationsnetzwerk (Aktenzeichen) des 6. Senats des Bundesfinanzhofs (Sugiyama Layout)."}
...
ggraph(g, "sugiyama") + 
    ...
    labs(
        title = paste(prefix.figuretitle,
                      "| Das interne Zitationsnetzwerk (Aktenzeichen und BFHE) des 6. Senats des Bundesfinanzhofs"),
        caption = caption
    )+
    theme(
        plot.title = element_text(size = 14,
