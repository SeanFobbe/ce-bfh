...
```{r}
sort(vertex_attr_names(igraph_citations))
```
...
```{r, CE-BFH_Zitationsnetzwerk_Senat-1_schwarzweiss, fig.width = 28, fig.height = 16, dpi = 150, dev = "png"}
...
```{r, CE-BFH_Zitationsnetzwerk_Senat-6_schwarzweiss, fig.width = 28, fig.height = 16, dpi = 150, dev = "png"}
