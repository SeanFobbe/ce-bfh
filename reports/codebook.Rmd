...
```{r, CE-BFH_Zitatationsnetzwerk_Graph_schwarzweiss, fig.width = 28, fig.height = 16, dpi = 150, dev = "png", fig.cap = "Das interne Zitationsnetzwerk (Aktenzeichen) des 1. Senats des Bundesfinanzhofs (Sugiyama Layout)."}

index <- which(igraph::V(igraph_citations)$senat == "I")
