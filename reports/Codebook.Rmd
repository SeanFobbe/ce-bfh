...
```{r, CE-BFH_07_Barplot_Registerzeichen, fig.height = 6, fig.width = 9}
...
```{r, CE-BFH_10_Barplot_Normen, fig.height = 14, fig.width = 9}
ggplot(data = freqtable.nosum) +
...
kable(freqtable.nosum[,cumulpercent:=NULL],
      ...
      col.names = c("Normen",
                    "Entscheidungen",
                    "% Gesamt"q))  %>% kable_styling(latex_options = "repeat_header")
```
...
```{r, CE-BFH_11_Density_Dateigroessen_PDF, fig.height = 6, fig.width = 9}
...
```{r, CE-BFH_12_Density_Dateigroessen_TXT, fig.height = 6, fig.width = 9}
...
```{r, CE-BFH_13_Density_Dateigroessen_HTML, fig.height = 6, fig.width = 9}
