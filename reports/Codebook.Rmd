...
```{r, CE-BFH_08_Barplot_Registerzeichen, fig.height = 14, fig.width = 10}
...
```{r, CE-BFH_11_Barplot_Entscheidungsjahr, fig.height = 6, fig.width = 9}
...
```{r, CE-BFH_12_Barplot_EingangsjahrISO, fig.height = 6, fig.width = 9}
ggplot(data = freqtable.nosum) +
...
```{r, CE-BFH_13_Density_Dateigroessen_PDF, fig.height = 6, fig.width = 9}
...
```{r, CE-BFH_14_Density_Dateigroessen_TXT, fig.height = 6, fig.width = 9}
...
```{r, CE-BFH_15_Density_Dateigroessen_HTML, fig.height = 6, fig.width = 9}
