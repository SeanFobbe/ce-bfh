...
```{r, CE-BFH_01_Density_Zeichen, fig.height = 6, fig.width = 9}
ggplot(data = dt.meta)+
...
```{r,  CE-BFH_02_Density_Tokens, fig.height = 6, fig.width = 9}
ggplot(data = dt.meta)+
...
```{r, CE-BFH_03_Density_Typen, fig.height = 6, fig.width = 9}
ggplot(data = dt.meta)+
...
```{r, CE-BFH_04_Density_Saetze, fig.height = 6, fig.width = 9}
ggplot(data = dt.meta)+
...
```{r, CE-BFH_05_Barplot_Entscheidungstyp, fig.height = 6, fig.width = 9}
...
freqtable.nosum <- freqtable.etyp[-.N]
...
```{r, CE-BFH_06_Barplot_Spruchkoerper_AZ, fig.height = 6, fig.width = 9}
...
```{r, CE-BFH_07_Barplot_Registerzeichen, fig.height = 14, fig.width = 10}
...
```{r, CE-BFH_08_Barplot_Entscheidungsjahr, fig.height = 6, fig.width = 9}
...
```{r, CE-BFH_09_Barplot_EingangsjahrISO, fig.height = 6, fig.width = 9}
ggplot(data = freqtable.nosum) +
...
```{r, CE-BFH_10_Density_Dateigroessen_PDF, fig.height = 6, fig.width = 9}
...
```{r, CE-BFH_11_Density_Dateigroessen_TXT, fig.height = 6, fig.width = 9}
...
```{r, CE-BFH_12_Density_Dateigroessen_HTML, fig.height = 6, fig.width = 9}
