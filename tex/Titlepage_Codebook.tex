...
{ \scshape \Huge \bfseries Corpus der Entscheidungen \\[0.5cm] \Huge \bfseries \scshape des \\[0.5cm] \Huge \bfseries \scshape Bundesfinanzhofs \\[0.5cm] \LARGE \bfseries (\datashort )};
