...
tar_target(dt.download.manifest.raw,
           f.download_manifest_make(sleep.min = 0.5,
                                    sleep.max = 2,
                                    verbose = FALSE,
...
<!-- Note: switch source to final download manifest later -->


```{targets tar.download.html}
tar_target(files.html,
                f.download(url = dt.download.manifest.raw$url_html,
                           filename = basename(dt.download.manifest.raw$url_html),
                           dir = "files/html",
                           sleep.min = 0.2,
                           sleep.max = 0.5,
                           retries = 3,
